...
if __name__ == "__main__":
    ...
    ## LSH
    K=[7,7,7,7,7,7,7,6,6,6,6,6,6,6,5,5,5,5,5,5,5,7,7,7,7,7,7,7,6,6,6,6,6,6,6,5,5,5,5,5,5,5,7,7,7,7,7,7,7,6,6,6,6,6,6,6,5,5,5,5,5,5,5]
    R=[5,5,10,10,15,20,30,5,5,10,10,15,20,30,5,5,10,10,15,20,30,5,5,10,10,15,20,30,5,5,10,10,15,20,30,5,5,10,10,15,20,30,5,5,10,10,15,20,30,5,5,10,10,15,20,30,5,5,10,10,15,20,30]
    B=[20,30,15,10,10,5,5,20,30,15,10,10,5,5,20,30,15,10,10,5,5,20,30,15,10,10,5,5,20,30,15,10,10,5,5,20,30,15,10,10,5,5,20,30,15,10,10,5,5,20,30,15,10,10,5,5,20,30,15,10,10,5,5]
    T=[0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.85,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9]
    for i in range(len(K)):
        # for n_rows in R:
        #     for n_bands in B:
        #         for threshold in T:
        print('K=%d R=%d B=%d T=%0.3f' % (K[i], R[i], B[i], T[i]))
        instance = LSH(K[i], R[i], B[i], T[i])
        instance.fit_data(documents, check_fp)
        output_path= '../datasets/cids_k%d_r%d_b%d_t%0.3f.txt' % (K[i], R[i], B[i], T[i])
